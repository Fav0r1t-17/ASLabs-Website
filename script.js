...
const TRANSLATIONS = {
    ...
    en: {
        ...
        'principle.one.body': 'Your files stay on your machine. Cloud processing is available when you need it.',
        ...
        'principle.three.body': 'Every product should save manual effort and produce something you can use right away.',
        ...
        'contact.title': 'Get in touch with a question, feedback, or support request.',
        'contact.subtitle': 'Questions about TextNormalizer, interest in W-Bee, or a product issue — send a message.',
