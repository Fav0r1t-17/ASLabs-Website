...
const TRANSLATIONS = {
    bg: {
        ...
        'hero.subtitle': 'AS Labs създава локални desktop инструменти за обработка на текст, документи и знание — с повече структура, контрол и практическа стойност.',
        ...
        'products.title': 'Инструменти за по-чиста работа с материал.',
        'products.subtitle': 'TextNormalizer обработва разхвърлян текст. W-Bee превръща източници за учене и работа в структурирани документи. И двата продукта са проектирани около контрол, яснота и локална обработка.',
        ...
        'wb.tagline': 'Превръща PDF-и, презентации, документи и записи в структурирани, четими учебни и работни материали.',
        ...
        'principle.one.body': 'Инструментите са създадени така, че работата да остава на вашата машина, когато процесът го позволява.',
        'principle.two.title': 'Структура пред шум',
        'principle.two.body': 'Фокусът не е върху ефекти, а върху по-добър ред: чист текст, ясни секции и използваеми документи.',
        'principle.three.title': 'Практически резултат',
        'principle.three.body': 'Всеки продукт трябва да спести ръчна работа и да завърши с материал, който може веднага да използвате.',

        'featured.tn.title': 'Когато текстът е разхвърлян, започнете от чиста основа.',
        ...
        'featured.wb.body': 'W-Bee е бъдещ продукт за превръщане на PDF-и, презентации, лекции и записи в чисти DOCX документи със запазена структура, език и изображения.',
        ...
        'tn.hero.title': 'Почистете разхвърляния текст, преди да забави работата ви.',
        ...
        'tn.usecases.body': 'Копирането от AI чатове, PDF-и и документи често оставя скрит шум. TextNormalizer го премахва преди текстът да влезе във вашия workflow.',
        ...
        'wb.what.p1': 'Повечето материали от лекции, изследвания или презентации не са създадени за четене — те са създадени за представяне. Слайдовете са фрагменти. PDF-ите са плътни. Аудио и видео съдържат знание, което често никога не стига до страница.',
        ...
        'wb.why.title': 'Ръчната трансформация на материали е бавна, повтаряща се и лесна за объркване.',
        ...
        'wb.why.p2': 'W-Bee поема тази работа без да изисква да докосвате шаблон, да пренареждате секции или ръчно да поставяте фигури. Входът е source material. Изходът е документ, готов за използване.',
        ...
        'wb.who3.title': 'Професионалисти и knowledge workers',
        ...
        'wb.how.title': 'От source file до готов DOCX в един последователен процес.',
        ...
        'wb.step1': 'Импортирайте source файл — PDF, презентация, документ или запис.',
    ...
    en: {
        ...
        'hero.subtitle': 'AS Labs builds local-first desktop tools for text, documents, and knowledge work — with more structure, control, and practical value.',
        ...
        'products.title': 'Tools for cleaner work with source material.',
        'products.subtitle': 'TextNormalizer processes messy text. W-Bee turns study and work sources into structured documents. Both products are designed around control, clarity, and local processing.',
        ...
        'wb.tagline': 'Turns PDFs, presentations, documents, and recordings into structured, readable study and work material.',
        ...
        'principle.one.body': 'The tools are designed so work stays on your machine whenever the workflow allows it.',
        'principle.two.title': 'Structure over noise',
        'principle.two.body': 'The focus is not effects, but better order: clean text, clear sections, and usable documents.',
        'principle.three.title': 'Practical output',
        'principle.three.body': 'Every product should save manual work and end with material you can use immediately.',

        'featured.tn.title': 'When text is messy, start from a clean base.',
        ...
        'wb.what.p1': 'Most documents that come out of lectures, research, or presentations are not designed to be read — they are designed to be presented. Slides are fragments. PDFs are dense. Audio and video capture knowledge that never makes it onto a page.',
        ...
        'wb.why.p2': 'W-Bee handles that work without requiring you to touch a template, reorder sections, or manually place figures. What comes in is source material. What comes out is a document ready to use.',
