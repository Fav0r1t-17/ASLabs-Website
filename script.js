...
const TRANSLATIONS = {
    bg: {
        ...
        'hero.eyebrow': 'Настолни инструменти. Офлайн.',
        'hero.title': 'По-чист текст. По-добри документи.',
        'hero.subtitle': 'AS Labs прави настолни инструменти за работа с текст и документи — офлайн, без абонамент, еднократна покупка.',
        'hero.cta1': 'Разгледай продуктите',
        'hero.cta2': 'Виж W-Bee',
        'hero.wbee.preview': 'Слайдове, PDF-и и записи — превърнати в чист, структуриран DOCX.',
        ...
        'wb.tagline': 'Превръща PDF-и, презентации и записи в структурирани, четими документи.',
        ...
        'principle.one.body': 'Работата остава на вашата машина — cloud обработката е опция, не задължение.',
        ...
        'principle.three.body': 'Всеки продукт трябва да завърши с нещо конкретно — готово за употреба.',
        ...
        'tn.hero.title': 'Почистете разхвърляния текст, преди да ви спре работата.',
        'tn.subtitle': 'Бързо почистване на текст от AI чатове, PDF-и и документи. Без облак, без акаунт, без абонамент.',
        ...
        'tn.usecases.title': 'За текст от AI инструменти, PDF-и и ежедневна работа.',
        ...
        'trust.one.body': 'TextNormalizer не докосва облака. Целият процес е на вашата машина.',
        'trust.two.title': 'Без акаунт',
        'trust.two.body': 'Купувате, изтегляте и използвате — без регистрация, без login.',
        ...
        'wb.hero.title': 'Превърнете лекции, PDF-и и записи в структуриран, четим документ.',
        'wb.subtitle': 'W-Bee взема PDF-и, слайдове, документи и записи и ги превръща в чисти, структурирани DOCX файлове — готови за четене, работа или споделяне.',
        ...
        'wb.what.title': 'От суров материал до документ, с който може да се работи.',
        ...
        'wb.what.p2': 'W-Bee анализира структурата на материала и открива естествените секции, теми и изображения. Резултатът е полиран документ, структуриран за ясно четене от начало до край.',
        'wb.why.label': 'Защо е важно',
        'wb.why.title': 'Ръчното превръщане на суров материал в документ е бавна, повтаряща се работа.',
        ...
        'wb.features.title': 'Организира и структурира — не резюмира и не преразказва.',
        'wb.f1.title': 'Структуриран документен изход',
        'wb.f1.body': 'Заглавия, текст и секции следват логическата структура на съдържанието — не произволно форматиране.',
        'wb.f2.title': 'Точно поставяне на изображения',
        'wb.f2.body': 'Фигурите се извличат и поставят там, където принадлежат — съобразено с позицията им в оригинала.',
        ...
        'wb.who1.body': 'За лекционни слайдове, академични текстове и записи — превърнати в материал за учене или писане.',
        ...
        'wb.how.body': 'Запазва структурата, терминологията и визуалните елементи — не ги изглажда в безлично резюме.',
    ...
    en: {
        ...
        'principle.one.body': 'Work stays on your machine — cloud processing is an option, not a requirement.',
        ...
        'principle.three.body': 'Every product ends with something concrete — ready to use.',
        ...
        'trust.one.body': 'TextNormalizer doesn\'t touch the cloud. Your text is processed locally, start to finish.',
        ...
        'wb.subtitle': 'W-Bee takes PDFs, slide decks, documents, and recordings and turns them into clean, well-structured DOCX files — ready to read, work from, or share.',
        'wb.fact.status.value': 'Soon',
