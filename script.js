...
const TRANSLATIONS = {
    bg: {
        ...
        'home.wb.point1': 'Структуриран DOCX документ',
        'home.wb.point2': 'Правилно запазени изображения',
        ...
        'tn.uc4.body': 'Намалете шума и нормализирайте текста, написан за машини, не за хора.',
        ...
        'wb.fact.status.value': 'Скоро',
        'wb.fact.status': 'В активна разработка',
        'wb.fact.output': 'Чист редактируем документ',
        ...
        'wb.final.title': 'По-добри документи от всякакъв тип — очаквайте скоро.',
        ...
        'ops.label': 'Операции',
        'ops.title': 'Пълен списък на поддържаните операции',
        'ops.subtitle': 'Всяка операция работи локално — текстът не напуска компютъра Ви.',
        'ops.caption': 'Поддържани операции в TextNormalizer — всички работят напълно офлайн',
        'ops.th.op': 'Операция',
        'ops.th.desc': 'Какво прави',
        'ops.th.case': 'Типичен случай',
        'ops.th.offline': 'Офлайн',
        'ops.r1.op': 'Почистване на интервали',
        'ops.r1.desc': 'Премахва излишни интервали, празни редове и разбити нови редове',
        'ops.r1.case': 'ИИ отговори, copy-paste от уеб',
        'ops.r2.op': 'Нормализация на Unicode',
        'ops.r2.desc': 'Заменя специални Unicode символи с ASCII еквиваленти',
        'ops.r2.case': 'Текст от PDF-и и документи',
        'ops.r3.op': 'Премахване на дубликати',
        'ops.r3.desc': 'Открива и изтрива повтарящи се редове от текста',
        'ops.r3.case': 'Логове, списъци и сурови бележки',
        'ops.r4.op': 'Извличане на URL-и',
        'ops.r4.desc': 'Извлича всички URL адреси от разхвърлян текст',
        'ops.r4.case': 'Уеб съдържание и доклади',
        'ops.r5.op': 'Извличане на имейли',
        'ops.r5.desc': 'Намира и извлича имейл адреси от текстов блок',
        'ops.r5.case': 'Листи с контакти и кореспонденция',
        'ops.r6.op': 'Промяна на регистър',
        'ops.r6.desc': 'Трансформира текста — главни, малки или само главни букви',
        'ops.r6.case': 'Форматиране на заглавия и списъци',
    ...
    en: {
        ...
        'ops.title': 'All supported operations',
        'ops.subtitle': 'Every operation runs locally — your text never leaves your machine.',
        'ops.caption': 'Supported operations in TextNormalizer — all work fully offline',
        'ops.th.op': 'Operation',
        'ops.th.desc': 'What it does',
        'ops.th.case': 'Typical use case',
        'ops.th.offline': 'Offline',
        'ops.r1.op': 'Whitespace cleanup',
        'ops.r1.desc': 'Removes extra spaces, blank lines and broken line breaks',
        'ops.r1.case': 'AI responses, web copy-paste',
        'ops.r2.op': 'Unicode normalization',
        'ops.r2.desc': 'Replaces special Unicode characters with ASCII equivalents',
        'ops.r2.case': 'Text from PDFs and documents',
        'ops.r3.op': 'Remove duplicates',
        'ops.r3.desc': 'Finds and removes repeated lines from the text',
        'ops.r3.case': 'Logs, lists and raw notes',
        'ops.r4.op': 'Extract URLs',
        'ops.r4.desc': 'Extracts all URL addresses from messy text',
        'ops.r4.case': 'Web content and reports',
        'ops.r5.op': 'Extract emails',
        'ops.r5.desc': 'Finds and extracts email addresses from a text block',
        'ops.r5.case': 'Contact lists and correspondence',
        'ops.r6.op': 'Change case',
        'ops.r6.desc': 'Transforms text — uppercase, lowercase, or Title Case',
        'ops.r6.case': 'Heading and list formatting',
