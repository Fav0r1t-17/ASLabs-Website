...
const TRANSLATIONS = {
    bg: {
        ...
        'hero.subtitle': 'AS Labs прави настолни инструменти за работа с текст и документи — локални, офлайн, с еднократна покупка.',
        ...
        'principle.one.body': 'Инструментите са проектирани така, че работата да остава на вашата машина — доколкото е възможно.',
    ...
    en: {
        ...
        'hero.subtitle': 'AS Labs builds local desktop tools for text and documents — offline, no account, one-time purchase.',
        ...
        'principle.one.body': 'The tools are designed so work stays on your machine wherever possible.',
